...
/**
 * Portlet implementation class PortletC Portlet recibe eventos
 */
public class PortletC extends GenericPortlet {
    ...
    @ProcessEvent(qname="{http://examen.portletsC.com}informacionC")
    public void procesarMiEvento(EventRequest request, EventResponse response) throws PortletException, IOException {
    	...
    	request.setAttribute("informacionC", informacion);
